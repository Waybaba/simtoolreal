...
SBATCH_SCRIPT="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)/debug_video_export.sbatch"
...
mkdir -p "${REPO_DIR}/outputs/slurm_logs/simtoolreal-video"
mkdir -p "${REPO_DIR}/outputs/videos"
